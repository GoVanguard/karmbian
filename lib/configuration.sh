...
PACKAGE_LIST_ADDITIONAL="network-manager wireless-tools lsof htop mmc-utils wget nano sysstat net-tools resolvconf jq libcrack2 cracklib-runtime curl"
#iozone3
...
PACKAGE_LIST_DESKTOP_FULL="libreoffice meld remmina kazam avahi-daemon transmission"
